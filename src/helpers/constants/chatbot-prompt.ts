...
Ejemplo: 'Poner: Puede navegar por [Aquí], en vez de poner: Puede navegar por (https://next-13-4-v-i.vercel.app/catalogue/products) que no se te pase solo texto del link porque es importante que el cliente pueda navegar.
